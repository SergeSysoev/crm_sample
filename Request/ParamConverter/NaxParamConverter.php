<?php
namespace NaxCrmBundle\Request\ParamConverter;
...
class NaxParamConverter implements ParamConverterInterface
{
    /**
     * @var ManagerRegistry
     */
    ...
    public function __construct(ManagerRegistry $registry = null, $kernel)
    {
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        ...
        $defClass = $configuration->getClass();

        $class = strpos($defClass, 'NaxCrmBundle') !== false ?
            $this->getInheritanceClass($defClass) :
            $defClass;
...
//        $class = $configuration->getClass();
    ...
    protected function getInheritanceClass($name)
    {
        $brand = $this->kernel->getContainer()->getParameter('brand');
        $brand = ucfirst($brand);
        $name = ucfirst($name);
        return BaseEntity::class($brand, $name);
    }
}